      ...
      >
        ...
        <div className="flex flex-col justify-between flex-1 p-5">
          <div>
            ...
            <h3 className="text-xl font-extrabold text-gray-900 leading-snug line-clamp-3 mb-3 group-hover:text-orange-500 transition-colors">{featured.title}</h3>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {visibleRest.map(post => (
          <Link key={post.id} href={`/blog/${post.slug}`} className="group block">
            ...
            <h4 className="text-gray-800 text-sm font-semibold leading-snug line-clamp-2 group-hover:text-orange-500 transition-colors">{post.title}</h4>
          </Link>
        ))}
      </div>
            ...
            return (
              <Link key={post.id} href={`/blog/${post.slug}`} className="group flex flex-col overflow-hidden rounded-xl border border-gray-200 hover:shadow-md transition-all bg-white">
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <h3 className="text-gray-900 font-bold text-sm leading-snug line-clamp-2 mb-2 group-hover:text-orange-500 transition-colors">{post.title}</h3>
