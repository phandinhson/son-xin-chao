...
export default function NewPost() {
  ...
  useEffect(() => {
    fetchCategories(true); // Lần đầu: auto-chọn category đầu tiên

    // Re-fetch khi user quay lại tab (ví dụ: vừa thêm danh mục ở tab khác)
    const onFocus = () => fetchCategories(false);
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="border border-gray-100 rounded-lg p-4 bg-white mb-4 font-sans">
                ...
                <div className="text-[#1a0dab] text-lg font-normal leading-snug line-clamp-1 mt-1">
                  {form.title ? (form.title.length > 60 ? form.title.slice(0, 57) + "..." : form.title) : <span className="text-gray-300">Tiêu đề bài viết...</span>}
                </div>
                <div className="text-sm text-gray-600 leading-snug mt-0.5 line-clamp-2">
                  {form.excerpt ? (form.excerpt.length > 160 ? form.excerpt.slice(0, 157) + "..." : form.excerpt) : <span className="text-gray-300">Mô tả ngắn sẽ hiển thị ở đây...</span>}
                </div>
              </div>
            ...
            <div className="p-4 space-y-3">
              ...
              {form.cover_image && (
                <div className="relative rounded-lg overflow-hidden border border-gray-200 group">
                  <Image src={form.cover_image} alt="Preview" width={600} height={144} className="w-full h-36 object-cover" unoptimized
