...
/* ──────────────────────────────────────────
   MAIN PAGE
────────────────────────────────────────── */
export default function HocAiClient({ initialVideos = [], initialTools = [] }: { initialVideos: Video[], initialTools: Tool[] }) {
  
  // 1. Lấy dữ liệu từ props làm dữ liệu gốc để render, tự động fallback về VIDEOS/TOOLS cứng nếu mảng từ server rỗng
