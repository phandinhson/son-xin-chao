...
const FALLBACK_ITEMS: NavItem[] = [
  ...
  { id: "f2d", label: "SEO Onpage",               href: "/dich-vu/seo-onpage", icon: "📝", description: "Tối ưu nội dung, cấu trúc, tốc độ trang", type: "item", parent_id: "f2", sort_order: 4, active: true, open_new_tab: false, badge: "", badge_color: "" },
  // Dịch vụ items
